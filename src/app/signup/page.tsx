...
function GoogleIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="24px" height="24px">
      ...
      <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C39.99,36.566,44,31.1,44,24C44,22.659,43.862,21.35,43.611,20.083z" />
    </svg>
  );
}
...
export default function SignupPage() {
  ...
  const handleAuthError = (error: any) => {
    ...
    if (error.code === 'auth/configuration-not-found') {
      description =
        'Authentication is not enabled for this project. Please enable Email/Password and Google sign-in in the Firebase console.';
